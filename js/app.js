// ==================================================================
// MÓDULO PRINCIPAL - DENTISTA INTELIGENTE (IA PRIVADA + FINANCEIRO)
// ==================================================================
(function() {
    ...
    function showNotification(msg) { console.log(msg); } // Placeholder
    ...
    function renderDashboard(container) {
        container.innerHTML = `
            <div class="p-8 bg-white shadow-2xl rounded-2xl border border-indigo-100">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
                    ...
                    <div class="p-4 bg-yellow-100 rounded-lg"><p class="text-gray-600 text-sm uppercase font-bold">Faturamento</p><h3 class="text-2xl font-bold text-yellow-800" id="dash-rec">R$ 0,00</h3></div>
                    <div class="p-4 bg-red-100 rounded-lg"><p class="text-gray-600 text-sm uppercase font-bold">Despesas</p><h3 class="text-2xl font-bold text-red-800" id="dash-exp">R$ 0,00</h3></div>
                </div>
                <div class="border p-4 rounded-xl bg-gray-50">
                    <h3 class="font-bold text-indigo-800 mb-2">Instruções Clínicas (IA)</h3>
                    <p class="text-xs text-gray-500 mb-2">Defina como a IA deve auxiliar você (Dentista) nas análises.</p>
                    <textarea id="brain-input" class="w-full p-2 border rounded text-sm" rows="3"></textarea>
                    <button id="save-brain-btn" class="mt-2 bg-indigo-600 text-white px-4 py-1 rounded text-sm">Salvar Cérebro</button>
                </div>
        ...
        document.getElementById('save-brain-btn').onclick = function() { brainRef.update({ promptDirectives: document.getElementById('brain-input').value }); alert("Cérebro Atualizado!"); };
    }
    ...
    function openJournal(id) {
        ...
        var html = `
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="border p-3 rounded-xl bg-white flex flex-col"><h4 class="font-bold text-xs text-gray-500 mb-2 uppercase">Financeiro</h4><div id="journal-fin-list" class="text-sm h-80 overflow-y-auto space-y-2 pr-2">Carregando...</div></div>
